...
public class ImageRequestProcessor extends IIORequestProcessor {
    ...
    /**
     * The image trim tolerance (distance between two color values) 
     * paarameter name to detect the border coords of an image.
     */
    ...
    /**
     * Status flag to indicate whether the source data reader will ignore
     * the content type of the origin source or not.
     * 
	...
	if (req == null || name == null || name.isEmpty()) {
	    return null;
	}

	final Map<String, String> params = getRequestParameters(req);
    ...
    /**
     * Gets the trim tolerance (max. distance between two colors) to automatically
     * trim (crop) images with borders/paddings.
     * 
     * @param req The related request object.
