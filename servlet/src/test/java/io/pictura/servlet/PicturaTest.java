...
public class PicturaTest {
    ...
    @Test
    public void testPad() {
        BufferedImage img2 = Pictura.pad(img, 10, Color.yellow);
        assertEquals(420, img2.getWidth());
        assertEquals(245, img2.getHeight());
        assertEquals(Color.yellow.getRGB(), img2.getRGB(0, 0));
        assertEquals(Color.yellow.getRGB(), img2.getRGB(9, 9));
        assertEquals(Color.yellow.getRGB(), img2.getRGB(419, 244));
        
        BufferedImage img3 = Pictura.pad(img, 10, Color.green);
        assertEquals(420, img3.getWidth());
        assertEquals(245, img3.getHeight());
        assertEquals(Color.green.getRGB(), img3.getRGB(0, 0));
        assertEquals(Color.green.getRGB(), img3.getRGB(9, 9));
        assertEquals(Color.green.getRGB(), img3.getRGB(419, 244));
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testPad_IllegalArgumentException0() throws Exception {
        Pictura.pad(null, 10, Color.yellow);
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testPad_IllegalArgumentException1() throws Exception {
        Pictura.pad(img, 0, Color.yellow);
    }
